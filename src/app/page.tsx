    ...
    <div>
      <main>
        <div className='container-home'>
          ...
          <div className="middle" style={{display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column", margin:"1rem", padding:"5rem"}}><h2 style={{color:"hsla(240, 11%, 93%, 0.902)"}}>Insert Text</h2></div>
